...
(1, '欢迎使用 Typecho', 'start',    1516520053, 1516520053, '<!--markdown-->如果您看到这篇文章,表示您的 blog 已经安装成功.',   0,  1,  NULL,   'post', 'publish',  NULL,   1,  '1',    '1',    '1',    0),
...
(1, 'admin',    '$P$BD5WcZVsOvI2QjiBDuDSNKbPzjByyx1',   'webmaster@yourdomain.com', 'http://www.typecho.org',   'admin',    1516520053, 1516521817, 0,  'administrator',    '656eec97643d3a1fd2210714a66042aa');
